const segTrendGauge = {
    ...
    reloadData: function(){
        ...
        this.data[0].name = `${_div}-${_seg} Profitability`;
        // console.log(this.data);
        document.getElementById('chart-seg-label1-gauge').textContent = this.data[0].value+ "%";
    },
    option: {
        grid: {
            show: false,
    ...
    initChart: function (load = false) {
        this.dom = document.getElementById('chart-seg-trend-gauge');
