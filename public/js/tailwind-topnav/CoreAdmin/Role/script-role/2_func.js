function reloadData(param) {
    ...
    console.log("TES");
    fetchWithTimeout(
        "/core-admin/manage-role/script-role/getall?dbcache=0",
        {
            // mode: "no-cors",
            // redirect: "follow",
            method: 'POST',
...
function setNewScript(param) {
    ...
    fetchWithTimeout(
        "/core-admin/manage-role/script-role/create",
        {
            method: 'POST',
            headers: {
                Accept: 'application/json',
...
function updateScript(param) {
    ...
    mainLoader.show("sending request...");
    fetchWithTimeout(
        "/core-admin/manage-role/script-role/update",
        {
            method: 'POST',
            headers: {
                Accept: 'application/json',
...
function removeScript(param) {
    ...
    mainLoader.show("sending request...");
    fetchWithTimeout(
        "/core-admin/manage-role/script-role/delete",
        {
            method: 'POST',
            headers: {
                Accept: 'application/json',
...
function removeMultiScript(id) {
    ...
    mainLoader.show("sending request...");
    fetchWithTimeout(
        "/core-admin/manage-role/script-role/deletemulti",
        {
            method: 'POST',
            headers: {
                Accept: 'application/json',
...
function updatestatusScript(param) {
    ...
    mainLoader.show("sending request...");
    fetchWithTimeout(
        "/core-admin/manage-role/script-role/updatestatus",
        {
            method: 'POST',
            headers: {
                Accept: 'application/json',
