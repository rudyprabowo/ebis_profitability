document.addEventListener('alpine:init', () => {
    Alpine.data('table', () => ({
        ...
        bind: {
            ...
            check_all: {
                ['@click']() {
                    ...
                    const layoutStore = Alpine.store('route_role');
        ...
        removeRow(idx) {
            ...
            let role = roleStore.getCurrentDataByIndex(idx);
            confirmStore.show(
                `${btn}`, `Are you sure you want to ${act} <b>Route ${role.id} - ${role.role}</b> ?`, "", "remove", `${btn}`,
                () => {
                    confirmStore.hide();
                    removeRoute(role);
                }
    ...
    Alpine.data('create', () => ({
        ...
        showEdit(idx) {
            const role_dataStore = Alpine.store('route_role');
