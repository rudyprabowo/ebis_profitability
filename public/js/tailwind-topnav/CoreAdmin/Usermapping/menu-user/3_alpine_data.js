document.addEventListener('alpine:init', () => {
    Alpine.data('table', () => ({
        ...
        bind: {
            ...
            check_all: {
                ['@click']() {
                    ...
                    const layoutStore = Alpine.store('menu_user');
        ...
        changeStatus(idx) {
            ...
            confirmStore.show(
                `${btn}`, `Are you sure you want to ${act} <b>Menu ${role.id} - ${role.menu}</b> ?`, "", "info", `${btn}`,
                () => {
                    this.$el.checked = !old_val;
                    confirmStore.hide();
        ...
        removeRow(idx) {
            ...
            let role = roleStore.getCurrentDataByIndex(idx);
            confirmStore.show(
                `${btn}`, `Are you sure you want to ${act} <b>Menu ${role.id} - ${role.menu}</b> ?`, "", "remove", `${btn}`,
                () => {
                    confirmStore.hide();
                    removeMenu(role);
                }
    ...
    Alpine.data('create', () => ({
        ...
        showEdit(idx) {
            const role_dataStore = Alpine.store('menu_user');
