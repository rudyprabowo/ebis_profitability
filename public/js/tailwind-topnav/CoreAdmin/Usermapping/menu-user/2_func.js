function reloadData(param) {
    ...
    console.log("TES");
    fetchWithTimeout(
        "/core-admin/mapping-user/menu-user/getall?dbcache=0",
        {
            // mode: "no-cors",
            // redirect: "follow",
            method: 'POST',
        ...
        .then((json) => {
            if (json.ret) {
                ...
                const roleStore = Alpine.store('menu_user');
...
function setNewMenu(param) {
    ...
    fetchWithTimeout(
        "/core-admin/mapping-user/menu-user/create",
        {
            method: 'POST',
            headers: {
                Accept: 'application/json',
...
function updateMenu(param) {
    ...
    mainLoader.show("sending request...");
    fetchWithTimeout(
        "/core-admin/mapping-user/menu-user/update",
        {
            method: 'POST',
            headers: {
                Accept: 'application/json',
...
function removeMenu(param) {
    ...
    mainLoader.show("sending request...");
    fetchWithTimeout(
        "/core-admin/mapping-user/menu-user/delete",
        {
            method: 'POST',
            headers: {
                Accept: 'application/json',
...
function removeMultiMenu(id) {
    ...
    mainLoader.show("sending request...");
    fetchWithTimeout(
        "/core-admin/mapping-user/menu-user/deletemulti",
        {
            method: 'POST',
            headers: {
                Accept: 'application/json',
...
function updatestatusMenu(param) {
    ...
    mainLoader.show("sending request...");
    fetchWithTimeout(
        "/core-admin/mapping-user/menu-user/updatestatus",
        {
            method: 'POST',
            headers: {
                Accept: 'application/json',
