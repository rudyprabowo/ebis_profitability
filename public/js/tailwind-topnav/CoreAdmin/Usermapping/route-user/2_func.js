function reloadData(param) {
    ...
    console.log("TES");
    fetchWithTimeout(
        "/core-admin/mapping-user/route-user/getall?dbcache=0",
        {
            // mode: "no-cors",
            // redirect: "follow",
            method: 'POST',
...
function setNewRoute(param) {
    ...
    fetchWithTimeout(
        "/core-admin/mapping-user/route-user/create",
        {
            method: 'POST',
            headers: {
                Accept: 'application/json',
...
function updateRoute(param) {
    ...
    mainLoader.show("sending request...");
    fetchWithTimeout(
        "/core-admin/mapping-user/route-user/update",
        {
            method: 'POST',
            headers: {
                Accept: 'application/json',
...
function removeRoute(param) {
    ...
    mainLoader.show("sending request...");
    fetchWithTimeout(
        "/core-admin/mapping-user/route-user/delete",
        {
            method: 'POST',
            headers: {
                Accept: 'application/json',
...
function removeMultiRoute(id) {
    ...
    mainLoader.show("sending request...");
    fetchWithTimeout(
        "/core-admin/mapping-user/route-user/deletemulti",
        {
            method: 'POST',
            headers: {
                Accept: 'application/json',
...
function updatestatusRoute(param) {
    ...
    mainLoader.show("sending request...");
    fetchWithTimeout(
        "/core-admin/mapping-user/route-user/updatestatus",
        {
            method: 'POST',
            headers: {
                Accept: 'application/json',
